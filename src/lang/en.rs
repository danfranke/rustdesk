...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("doc_mac_permission", "https://vlcloud.com.br/docs/en/client/mac/#enable-permissions"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use VLRemote and start the service, do not proceed and hang up immediately."),
        ...
        ("doc_fix_wayland", "https://vlcloud.com.br/docs/en/client/linux/#x11-required"),
