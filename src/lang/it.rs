...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete VLRemote..."),
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), VLRemote potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare VLRemote a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Click to download", "Download"),
        ("Click to update", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a VLRemote il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a VLRemote il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a VLRemote di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [VLRemote Input]."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep VLRemote background service", "Mantieni il servizio di VLRemote in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione VLRemote, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show VLRemote", "Visualizza VLRemote"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a VLRemote 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a VLRemote."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di VLRemote."),
        ...
        ("verify_VLRemote_password_tip", "Conferma password VLRemote"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare VLRemote e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_VLRemote_server_pro_to_{}_tip", "Aggiorna VLRemote Server Pro alla versione {} o successiva!"),
        ...
        ("selinux_tip", "In questo dispositivo è abilitato SELinux, che potrebbe impedire il corretto funzionamento di VLRemote come lato controllato."),
        ...
        ("powered_by_me", "Alimentato da VLRemote"),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra VLRemote è aperta"),
        ...
        ("floating_window_tip", "It helps to keep VLRemote background service"),
        ...
        ("About VLRemote", "Info su VLRemote"),
