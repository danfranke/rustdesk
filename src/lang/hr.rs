...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Spajanje na VLRemote mrežu..."),
        ...
        ("install_tip", "Zbog UAC-a VLRemote ne može u nekim slučajevima raditi pravilno. Da biste prevazišli UAC, kliknite na tipku ispod da instalirate VLRemote na sustav."),
        ...
        ("config_acc", "Da biste daljinski kontrolirali radnu površinu, VLRemote-u trebate dodijeliti prava za \"Pristupačnost\"."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, VLRemote-u trebate dodijeliti prava za \"Snimanje zaslona\"."),
        ...
        ("android_input_permission_tip1", "Da bi ste daljinski uređaj kontrolirali vašim Android uređajem preko miša ili na dodir, trebate dopustiti VLRemote-u da koristi servis \"Pristupačnost\"."),
        ("android_input_permission_tip2", "Molimo prijeđite na sljedeću stranicu podešavanja sustava, pronađite i unesite [Instalirani servisi], uključite servis [VLRemote Input]."),
        ...
        ("Language", "Jezik"),
        ("Keep VLRemote background service", "Zadrži VLRemote kao pozadinski servis"),
        ("Ignore Battery Optimizations", "Zanemari optimizaciju baterije"),
        ("android_open_battery_optimizations_tip", "Ako želite onemogućiti ovu funkciju, molimo idite na sljedeću stranicu za podešavanje VLRemote aplikacije, pronađite i uđite u [Baterija], onemogućite [Neograničeno]"),
        ...
        ("Show VLRemote", "Prikaži VLRemote"),
        ...
        ("config_input", "Za upravljanje udaljenom radnom površinom pomoću tipkovnice, morate dodijeliti VLRemoteu dopuštenje \"Nadzor unosa\"."),
        ("config_microphone", "Da biste razgovarali na daljinu, morate dopustiti VLRemoteu \"Snimanje zvuka\"."),
        ...
        ("still_click_uac_tip", "Još uvijek zahtijeva da udaljeni korisnik klikne OK u UAC prozoru pokrenutog VLRemotea."),
        ...
        ("verify_VLRemote_password_tip", "Provjera lozinke za VLRemote"),
        ...
        ("scam_text1", "Ako razgovarate telefonom s nekim koga NE POZNAJETE i NE VJERUJETE tko vas je zamolio da koristite i pokrenete VLRemote, nemojte nastavljati razgovor i odmah spustite slušalicu."),
        ...
        ("upgrade_VLRemote_server_pro_to_{}_tip", "Ažurirajte VLRemote Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "Na vašem uređaju je omogućen SELinux, što može spriječiti VLRemote da pravilno radi kao upravljana strana."),
        ...
        ("powered_by_me", "Pokreće VLRemote"),
