...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do VLRemote..."),
        ...
        ("install_tip", "Devido ao UAC, o VLRemote não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o VLRemote no sistema."),
        ...
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao VLRemoteDesk permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao VLRemoteDesk permissões de \"Gravar a Tela\"/"),
        ...
        ("TVLRemote this device", "Confiar neste dispositivo"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o VLRemoteDesk use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [VLRemoteDesk Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep VLRemoteDesk background service", "Manter o serviço do VLRemoteDesk executando em segundo plano"),
        ...
        ("Show VLRemoteDesk", "Exibir VLRemoteDesk"),
        ...
        ("config_input", "Para controlar a área de trabalho remota com teclado, você precisa conceder a permissão \"Monitoramento de entrada\" do VLRemoteDesk."),
        ("config_microphone", "Para falar remotamente, você precisa conceder a permissão \"Gravar áudio\" do VLRemoteDesk."),
        ...
        ("still_click_uac_tip", "Ainda requer que o usuário remoto clique em OK na janela UAC da execução do VLRemoteDesk."),
        ...
        ("verify_VLRemotedesk_password_tip", "Verifique a senha do VLRemoteDesk"),
        ...
        ("scam_text1", "Se você estiver ao telefone com alguém que NÃO conhece e em quem NÃO confia e essa pessoa pedir para você usar o VLRemoteDesk e iniciar o serviço, NÃO faça isso !! e desligue imediatamente."),
        ...
        ("upgrade_VLRemotedesk_server_pro_to_{}_tip", "Atualize o VLRemoteDesk Server Pro para a versão {} ou superior."),
        ...
        ("selinux_tip", "O SELinux está ativado em seu dispositivo, o que pode impedir que o VLRemoteDesk funcione corretamente como dispositivo controlado."),
        ...
        ("powered_by_me", "Desenvolvido por VLRemoteDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir conexões apenas quando a janela do VLRemoteDesk estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço VLRemoteDesk em segundo plano"),
        ...
        ("About VLRemoteDesk", "Sobre VLRemoteDesk"),
        ...
        ("Set PIN", "Definir PIN"),
        ("Enable tVLRemoteed devices", "Habilitar dispositivos confiáveis"),
        ("Manage tVLRemoteed devices", "Gerenciar dispositivos confiáveis"),
        ("Platform", "Plataforma"),
        ("Days remaining", "Dias restantes"),
        ("enable-tVLRemoteed-devices-tip", "Ignore a verificação de dois fatores em dispositivos confiáveis"),
