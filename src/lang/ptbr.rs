...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao VLRemote permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao VLRemote permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o VLRemote use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [VLRemote Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep VLRemote background service", "Manter o serviço do VLRemote executando em segundo plano"),
        ...
        ("config_input", "Para controlar a área de trabalho remota com teclado, você precisa conceder a permissão \"Monitoramento de entrada\" do VLRemote."),
        ("config_microphone", "Para falar remotamente, você precisa conceder a permissão \"Gravar áudio\" do VLRemote."),
        ...
        ("still_click_uac_tip", "Ainda requer que o usuário remoto clique em OK na janela UAC da execução do VLRemote."),
        ...
        ("verify_VLRemote_password_tip", "Verifique a senha do VLRemote"),
        ...
        ("scam_text1", "Se você estiver ao telefone com alguém que NÃO conhece e em quem NÃO confia e essa pessoa pedir para você usar o VLRemote e iniciar o serviço, NÃO faça isso !! e desligue imediatamente."),
        ...
        ("upgrade_VLRemote_server_pro_to_{}_tip", "Atualize o VLRemote Server Pro para a versão {} ou superior."),
        ...
        ("selinux_tip", "O SELinux está ativado em seu dispositivo, o que pode impedir que o VLRemote funcione corretamente como dispositivo controlado."),
        ...
        ("powered_by_me", "Desenvolvido por VLRemote"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir conexões apenas quando a janela do VLRemote estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço VLRemote em segundo plano"),
