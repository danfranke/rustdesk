...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem VLRemote..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, VLRemote v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Click to download", "Klikni za prenos"),
        ("Click to update", "Klikni za posodobitev"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate VLRemoteu dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate VLRemoteu dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno VLRemoteu dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »VLRemote Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep VLRemote background service", "Ohrani VLRemoteovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije VLRemote, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "VLRemote potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "VLRemote potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_VLRemote_password_tip", "Preveri geslo za VLRemote"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite VLRemote, prekinite klic in program zaprite."),
        ("scam_text2", "VLRemote omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_VLRemote_server_pro_to_{}_tip", "Prosimo, nadgradite VLRemote Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo VLRemote"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno VLRemotea odprto"),
        ...
        ("floating_window_tip", "Pomaga pri VLRemote storitvi v ozadju"),
