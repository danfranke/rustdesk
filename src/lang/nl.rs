...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Klaar"),
        ("Established", "Opgezet"),
        ("connecting_status", "Verbinding maken met het VLRemote netwerk..."),
        ...
        ("install_tip", "Door UAC-beperkingen lukt het niet altijd om uw bureaublad op afstand te bedienen. Installeer VLRemote op het systeem om dit probleem te voorkomen."),
        ("Click to upgrade", "Klik voor upgrade"),
        ("Click to download", "Klik om te downloaden"),
        ("Click to update", "Klik om bij te werken"),
        ("Configure", "Configureren"),
        ("config_acc", "Om uw bureaublad op afstand te kunnen bedienen, moet u VLRemote toestemming voor \"toegankelijkheid\" geven."),
        ("config_screen", "Om toegang te krijgen tot het externe bureaublad, moet u VLRemote toestemming voor \"schermregistratie\" geven."),
        ...
        ("android_input_permission_tip1", "Om ervoor te zorgen dat een extern apparaat uw Android-apparaat kan besturen via muis of aanraking, moet u VLRemote toestaan om de \"Toegankelijkheid\" service te gebruiken."),
        ("android_input_permission_tip2", "Ga naar de volgende pagina met systeeminstellingen, zoek en ga naar [Geïnstalleerde Services], schakel de service [VLRemote Input] in."),
        ...
        ("Language", "Taal"),
        ("Keep VLRemote background service", "VLRemote achtergronddienst behouden"),
        ...
        ("config_input", "Om het externe bureaublad vanaf het toetsenbord te kunnen bedienen, moet u VLRemote de rechten \"Invoer vastleggen\" geven."),
        ("config_microphone", "Om op afstand te kunnen chatten, moet u VLRemote 'Audio opnemen' rechten geven."),
        ...
        ("still_click_uac_tip", "De gebruiker op afstand moet altijd bevestigen via het UAC-venster van de werkende VLRemote."),
        ...
        ("verify_VLRemote_password_tip", "Bevestiging wachtwoord VLRemote"),
        ...
        ("scam_text1", "Als u aan de telefoon bent met iemand die u NIET kent EN VERTROUWT en die u heeft gevraagd om VLRemote te gebruiken en de service te starten, ga dan niet verder en hang onmiddellijk op."),
        ...
        ("upgrade_VLRemote_server_pro_to_{}_tip", "Upgrade VLRemote Server Pro naar versie {} of nieuwer!"),
        ...
        ("selinux_tip", "SELinux is ingeschakeld op dit apparaat, waardoor VLRemote mogelijk niet goed functioneert als een gecontroleerde kant."),
        ...
        ("powered_by_me", "Werkt met VLRemote"),
        ...
        ("allow-only-conn-window-open-tip", "Alleen verbindingen toestaan als het VLRemote-venster geopend is"),
        ...
        ("floating_window_tip", "Helpt VLRemote op de achtergrond actief te houden"),
