...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kullanıcı Hesabı Denetimi nedeniyle, VLRemote bir uzak masaüstü olarak düzgün çalışmayabilir. Bu sorunu önlemek için, VLRemote'i sistem seviyesinde kurmak için aşağıdaki butona tıklayın."),
        ...
        ("Configure", "Ayarla"),
        ("config_acc", "Masaüstünüzü dışarıdan kontrol etmek için VLRemote'e \"Erişilebilirlik\""),
        ("config_screen", "Masaüstünüzü dışarıdan kontrol etmek için VLRemote'e \"Ekran Kaydı\" iznini vermeniz gerekir."),
        ...
        ("android_input_permission_tip1", "Uzak bir cihazın Android cihazınızı fare veya dokunma yoluyla kontrol edebilmesi için, VLRemote'in \"Erişilebilirlik\" özelliğini kullanmasına izin vermelisiniz."),
        ("android_input_permission_tip2", "Sonraki sistem ayarları sayfasına gidin, [Yüklü Hizmetler]'i bulun ve erişin, [VLRemote Girişi] hizmetini etkinleştirin."),
        ...
        ("Language", "Dil"),
        ("Keep VLRemote background service", "VLRemote arka plan hizmetini sürdürün"),
        ...
        ("Show VLRemote", "VLRemote'i Göster"),
        ("This PC", "Bu PC"),
        ("or", "veya"),
        ...
        ("config_input", "Uzaktaki masaüstünü klavye ile kontrol etmek için VLRemote'e \"Giriş İzleme\" izinleri vermelisiniz."),
        ("config_microphone", "Uzaktan konuşmak için VLRemote'e \"Ses Kaydı\" izinleri vermelisiniz."),
        ...
        ("still_click_uac_tip", "Uzaktaki kullanıcının çalışan VLRemote'in UAC penceresinde hala Tamam'ı tıklaması gerekmektedir."),
        ...
        ("verify_VLRemote_password_tip", "VLRemote parolasını doğrulayın"),
